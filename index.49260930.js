 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Tt(),t=It(e,"auth");return t.isInitialized()?t.getImmediate():cr(e,{popupRedirectResolver:qi,persistence:[Va,ma,ya]})}($i),eo=(Qi=e(c)(e(l).mark((function t(){var r,n,a,i;return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=Yi.loginEmail.value,n=Yi.loginPassword.value,e.prev=2,e.next=5,t=r,o=n,sa(Ae(Zi),qn.credential(t,o));case 5:(a=e.sent).user.displayName=Yi.loginUsername.value,i=a.user.displayName,Yi.checkbox.checked?localStorage.setItem(Xi,"".concat(i)):Yi.checkbox.checked||localStorage.removeItem(Xi),console.log(i),no(),e.next=16;break;case 13:e.prev=13,e.t0=e.catch(2),to(e.t0);case 16:case"end":return e.stop()}var t,o}),t,null,[[2,13]])}))),function(){return Qi.apply(this,arguments)});function to(e){e.code==Qt.INVALID_PASSWORD?alert("Wrong password. Try again."):alert("Error: ".concat(e.message))}Yi.loginBtn.addEventListener("click",eo);var ro=function(){var t=e(c)(e(l).mark((function t(){var r,n;return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=Yi.signupEmail.value,n=Yi.signupPassword.value,e.prev=2,e.next=5,ca(Zi,r,n);case 5:e.sent,alert("You are signed up now"),e.next=12;break;case 9:e.prev=9,e.t0=e.catch(2),to(e.t0);case 12:case"end":return e.stop()}}),t,null,[[2,9]])})));return function(){return t.apply(this,arguments)}}();function no(){return ao.apply(this,arguments)}function ao(){return ao=e(c)(e(l).mark((function t(){return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:da(Zi,(function(e){var t=localStorage.getItem(Xi);e||(Yi.loginForm.classList.remove("logout-modal--hidden"),Yi.logoutModal.classList.add("logout-modal--hidden")),t&&(Yi.loginForm.classList.add("logout-modal--hidden"),Yi.logoutModal.classList.remove("logout-modal--hidden"),Yi.logoutText.innerHTML="You are logged in as ".concat(t)),e&&!t&&(Yi.loginForm.classList.add("logout-modal--hidden"),Yi.logoutModal.classList.remove("logout-modal--hidden"),Yi.logoutText.innerHTML="You are logged in as ".concat(e.displayName))}));case 1:case"end":return e.stop()}}),t)}))),ao.apply(this,arguments)}Yi.signupBtn.addEventListener("click",ro);var io=function(){var t=e(c)(e(l).mark((function t(){return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,Ae(Zi).signOut();case 2:localStorage.removeItem(Xi),Yi.loginForm.classList.remove("logout-modal--hidden"),Yi.logoutModal.classList.add("logout-modal--hidden"),alert("You're not logged in anymore");case 6:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}();Yi.logoutBtn.addEventListener("click",io);var oo=document.querySelector("body"),so=localStorage.getItem(Xi),uo=document.querySelector(".gallery"),co=document.querySelector(".backdrop"),lo=document.querySelector(".modal__button"),fo=document.querySelector(".modal-info__container"),ho=document.querySelector(".modal"),po=0,vo={};function mo(e){ho.contains(e.target)&&!lo.contains(e.target)||(oo.classList.remove("modal-open"),co.classList.add("is-hidden"))}uo.addEventListener("click",(function(e){var t=JSON.parse(localStorage.getItem(g));e.preventDefault(),po=Number(e.target.dataset.id),t.map((function(e){var t,r,n,a,i,o,s,c,l,d;e.id===po&&(r=(t=e).poster_path,n=t.title,a=t.original_title,i=t.genre_ids,o=t.overview,s=t.vote_count,c=t.vote_average,l=t.popularity,d='\n      <img src="'.concat(r?u.Movie.IMG_PATH+r:"https://yt3.ggpht.com/AAKF_677TIvjFz_9xFF0R6PgiVd0kRpEtY6APSxSDRP65nXg8hkn9NFsz2bRd9_Z37DJ9D_b=s900-c-k-c0x00ffffff-no-rj",'" alt="').concat(n,'" class="modal-info__img">\n      <div class="modal-info">\n          <h2 class="modal-info__movie-name">').concat(n.toUpperCase(),'</h2>\n          <table class="modal-info__list" >\n              <tr class="modal-info__item">\n                <th class="modal-info__title">Vote / Votes</th>\n                <th class="modal-info__content"><span class="modal-info__content-color"> ').concat(Math.round(10*c)/10,' </span> / <span class="modal-info__content-color modal-info__content-color--votes">').concat(s,'</span></th>\n              </tr>\n              <tr class="modal-info__item">\n                <td class="modal-info__title">Popularity</td>\n                <td class="modal-info__content">').concat(l.toFixed(1),'\n                </td>\n              </tr>\n              <tr class="modal-info__item">\n                <td class="modal-info__title">Original Title</td>\n                <td class="modal-info__content modal-info__content--text">').concat(a.toUpperCase(),'</td>\n              </tr>\n              <tr class="modal-info__item">\n                <td class="modal-info__title">Genre</td>\n                <td class="modal-info__content">').concat(p(i),'</td>\n              </tr>\n              </table>            \n                  <p class="modal-info__article-title">About</p>\n                  <p class="modal-info__article">').concat(o,'</p>\n                  <div class="container-btn">\n            <button type="button" class="btn" name="watched">add to watched</button>\n            <button type="button" class="btn" name="queue">add to queue</button>\n        </div>'),fo.innerHTML=d,vo=e)})),e.target!==e.currentTarget&&(oo.classList.add("modal-open"),co.classList.remove("is-hidden"))})),lo.addEventListener("click",mo),fo.addEventListener("click",(function(e){"watched"===e.target.name&&(so?bo():alert('If you want to add movie to "Watched" then you have to log in first.'));"queue"===e.target.name&&(so?Io():alert('If you want to add movie to "Queue" then you have to log in first.'))})),co.addEventListener("click",mo);var go=[],yo=[],ko="themovie-watched-lib",_o="themovie-queue-lib";var bo=function(){go=JSON.parse(localStorage.getItem(ko))||[];var e=[];go.map((function(t){return e.push(t.id)})),e.includes(po)||(go.push(vo),localStorage.setItem(ko,JSON.stringify(go)),console.log("watched:  "+e))},Io=function(){yo=JSON.parse(localStorage.getItem(_o))||[];var e=[];yo.map((function(t){return e.push(t.id)})),e.includes(po)?console.log("есть уже"):(yo.push(vo),localStorage.setItem(_o,JSON.stringify(yo)),console.log("queue:  "+e))},wo=document.querySelector(".footer-text__link"),Eo=document.querySelector(".backdrop-team"),So=document.querySelector(".modal-team__button"),xo=document.querySelector("body");wo.addEventListener("click",(function(e){e.preventDefault(),Eo.classList.remove("is-hidden"),xo.classList.add("modal-team-open")})),So.addEventListener("click",(function(e){Eo.classList.add("is-hidden"),xo.classList.remove("modal-team-open")}));var To=document.querySelector("#switch-form__link-login"),Oo=document.querySelector("#switch-form__link-sign-up"),No=document.querySelector(".close__button"),Ao=document.querySelector(".close-login__button"),Ro=document.querySelector(".sign-up__overlay"),Lo=document.querySelector(".log-in__overlay"),Do=document.querySelector(".login__button"),Co=document.querySelector(".signup__button"),Po=document.querySelector("body");function Mo(e){e.preventDefault(),Lo.classList.toggle("log-in__overlay--hidden"),Ro.classList.toggle("sign-up__overlay--hidden")}function Uo(e){Po.classList.remove("modal-open"),Lo.classList.add("log-in__overlay--hidden"),Ro.classList.add("sign-up__overlay--hidden")}To.addEventListener("click",Mo),Oo.addEventListener("click",Mo),No.addEventListener("click",Uo),Ao.addEventListener("click",Uo),Do.addEventListener("click",(function(e){Lo.classList.remove("log-in__overlay--hidden"),Po.classList.add("modal-open")})),Co.addEventListener("click",(function(e){Ro.classList.remove("sign-up__overlay--hidden"),Po.classList.add("modal-open")}))}();
//# sourceMappingURL=index.49260930.js.map
