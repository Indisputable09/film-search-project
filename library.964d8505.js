 ...
 * limitations under the License.
 */
const T="firebase-heartbeat-store";let N=null;function k(){return N||(N=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(T)}}).catch((e=>{throw E.create("storage-open",{originalErrorMessage:e.message})}))),N}async function R(e,t){var n;try{const n=(await k()).transaction(T,"readwrite"),r=n.objectStore(T);return await r.put(t,O(e)),n.done}catch(e){throw E.create("storage-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message})}}function O(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function N(e){return e&&e._delegate?e._delegate:e}})),o.register("7vF8m",(function(e,n){t(e.exports,"LogLevel",(function(){return i})),t(e.exports,"Logger",(function(){return l})),t(e.exports,"setLogLevel",(function(){return h})),t(e.exports,"setUserLogHandler",(function(){return d}));
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pe(e,t,n=!1){const r=await $(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Oe._forOperation(e,"link",r)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Me(e,t,n=!1){const r="signIn",i=await Ce(e,r,t),o=await Oe._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(o.user),o}async function xe(e,t){return Me(de(e),t)}async function Be(e,t,n){const r=de(e),i=await Re(r,{returnSecureToken:!0,email:t,password:n}),o=await Oe._fromIdTokenResponse(r,"signIn",i);return await r._updateCurrentUser(o.user),o}function Fe(e,t,n){return xe((0,r.getModularInstance)(e),be.credential(t,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new N(3e4,6e4);function Mt(){const e=Qe().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let xt=null;function Bt(e){return xt=xt||function(e){return new Promise(((t,n)=>{var r,i,o;function s(){Mt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Mt(),n(m(e,"network-request-failed"))},timeout:Ut.get()})}if(null===(i=null===(r=Qe().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Qe().gapi)||void 0===o?void 0:o.load)){const t=lt("iframefcb");return Qe()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},ut(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw xt=null,e}))}(e),xt}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=library.964d8505.js.map
