 ...
 * limitations under the License.
 */
var lt=function(){"use strict";function t(r){e(i)(this,t),this.container=r}return e(o)(t,[{key:"getPlatformInfoString",value:function(){return this.container.getProviders().map((function(e){if(function(e){var t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){var t=e.getImmediate();return"".concat(t.library,"/").concat(t.version)}return null})).filter((function(e){return e})).join(" ")}}]),t}();var dt,ft,ht="@firebase/app",pt="0.7.28",vt=new qe("@firebase/app"),mt="[DEFAULT]",gt=(dt={},e(q)(dt,ht,"fire-core"),e(q)(dt,"@firebase/app-compat","fire-core-compat"),e(q)(dt,"@firebase/analytics","fire-analytics"),e(q)(dt,"@firebase/analytics-compat","fire-analytics-compat"),e(q)(dt,"@firebase/app-check","fire-app-check"),e(q)(dt,"@firebase/app-check-compat","fire-app-check-compat"),e(q)(dt,"@firebase/auth","fire-auth"),e(q)(dt,"@firebase/auth-compat","fire-auth-compat"),e(q)(dt,"@firebase/database","fire-rtdb"),e(q)(dt,"@firebase/database-compat","fire-rtdb-compat"),e(q)(dt,"@firebase/functions","fire-fn"),e(q)(dt,"@firebase/functions-compat","fire-fn-compat"),e(q)(dt,"@firebase/installations","fire-iid"),e(q)(dt,"@firebase/installations-compat","fire-iid-compat"),e(q)(dt,"@firebase/messaging","fire-fcm"),e(q)(dt,"@firebase/messaging-compat","fire-fcm-compat"),e(q)(dt,"@firebase/performance","fire-perf"),e(q)(dt,"@firebase/performance-compat","fire-perf-compat"),e(q)(dt,"@firebase/remote-config","fire-rc"),e(q)(dt,"@firebase/remote-config-compat","fire-rc-compat"),e(q)(dt,"@firebase/storage","fire-gcs"),e(q)(dt,"@firebase/storage-compat","fire-gcs-compat"),e(q)(dt,"@firebase/firestore","fire-fst"),e(q)(dt,"@firebase/firestore-compat","fire-fst-compat"),e(q)(dt,"fire-js","fire-js"),e(q)(dt,"firebase","fire-js-all"),dt),yt=new Map,kt=new Map;function _t(e,t){try{e.container.addComponent(t)}catch(r){vt.debug("Component ".concat(t.name," failed to register with FirebaseApp ").concat(e.name),r)}}function bt(e){var t=e.name;if(kt.has(t))return vt.debug("There were multiple attempts to register component ".concat(t,".")),!1;kt.set(t,e);var r=!0,n=!1,a=void 0;try{for(var i,o=yt.values()[Symbol.iterator]();!(r=(i=o.next()).done);r=!0){_t(i.value,e)}}catch(e){n=!0,a=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw a}}return!0}function It(e,t){var r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qr(e){return Wr.apply(this,arguments)}function Wr(){return(Wr=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
e(c)(e(l).mark((function t(r){var n,a,i,o,s,u,c,d,f,h,p;return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return a=r.auth,e.next=4,r.getIdToken();case 4:return i=e.sent,e.next=7,Fr(r,Lr(a,{idToken:i}));case 7:ar(null==(o=e.sent)?void 0:o.users.length,a,"internal-error"),s=o.users[0],r._notifyReloadListener(s),u=(null===(n=s.providerUserInfo)||void 0===n?void 0:n.length)?Kr(s.providerUserInfo):[],c=Gr(r.providerData,u),d=r.isAnonymous,f=!(r.email&&s.passwordHash||(null==c?void 0:c.length)),h=!!d&&f,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new Br(s.createdAt,s.lastLoginAt),isAnonymous:h},Object.assign(r,p);case 18:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function zr(){return(zr=e(c)(e(l).mark((function t(r){var n;return e(l).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=Ae(r),e.next=3,qr(n);case 3:return e.next=5,n.auth._persistUserIfCurrent(n);case 5:n.auth._notifyListenersIfCurrent(n);case 6:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Gr(t,r){var n=t.filter((function(e){return!r.some((function(t){return t.providerId===e.providerId}))}));return e(W)(n).concat(e(W)(r))}function Kr(e){return e.map((function(e){var t=e.providerId,r=Kt(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}}))}function Jr(e,t){return Yr.apply(this,arguments)}function Yr(){return(Yr=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Bn=function(){"use strict";function t(){e(i)(this,t),this.providerId=t.PROVIDER_ID}return e(o)(t,null,[{key:"credential",value:function(e,t){return An._fromEmailAndPassword(e,t)}},{key:"credentialWithLink",value:function(e,t){var r=Hn.parseLink(t);return ar(r,"argument-error"),An._fromEmailAndCode(e,r.code,r.tenantId)}}]),t}();Bn.PROVIDER_ID="password",Bn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Bn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
qa("rcb"),new pr(3e4,6e4);var Wa="recaptcha";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ka=function(){"use strict";function t(r){e(i)(this,t),this.providerId=t.PROVIDER_ID,this.auth=kn(r)}return e(o)(t,[{key:"verifyPhoneNumber",value:function(e,t){return za(this.auth,e,Ae(t))}}],[{key:"credential",value:function(e,t){return Vn._fromVerification(e,t)}},{key:"credentialFromResult",value:function(e){var r=e;return t.credentialFromTaggedObject(r)}},{key:"credentialFromError",value:function(e){return t.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var r=t.phoneNumber,n=t.temporaryProof;return r&&n?Vn._fromTokenResponse(r,n):null}}]),t}();
/**
 * @license
 * Copyright 2021 Google LLC
 *
