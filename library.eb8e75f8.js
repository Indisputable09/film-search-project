 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Me(e,t,r=!1){const n="signIn",i=await Ce(e,n,t),o=await Le._fromIdTokenResponse(e,n,i);return r||await e._updateCurrentUser(o.user),o}async function xe(e,t){return Me(de(e),t)}async function Be(e,t,r){const n=de(e),i=await Re(n,{returnSecureToken:!0,email:t,password:r}),o=await Le._fromIdTokenResponse(n,"signIn",i);return await n._updateCurrentUser(o.user),o}function Fe(e,t,r){return xe((0,n.getModularInstance)(e),be.credential(t,r))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ft.PROVIDER_ID="phone",ft.PHONE_SIGN_IN_METHOD="phone";class gt extends pe{_getIdTokenResponse(e){return ve(e,this._buildIdpRequest())}_linkToIdToken(e,t){return ve(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return ve(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function mt(e){return Me(e.auth,new gt(e),e.bypassAuthState)}function vt(e){const{auth:t,user:r}=e;return y(r,t,"internal-error"),Ue(r,new gt(e),e.bypassAuthState)}async function _t(e){const{auth:t,user:r}=e;return y(r,t,"internal-error"),Pe(r,new gt(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new O(3e4,6e4);function Mt(){const e=Qe().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let xt=null;function Bt(e){return xt=xt||function(e){return new Promise(((t,r)=>{var n,i,o;function s(){Mt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Mt(),r(m(e,"network-request-failed"))},timeout:Ut.get()})}if(null===(i=null===(n=Qe().gapi)||void 0===n?void 0:n.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Qe().gapi)||void 0===o?void 0:o.load)){const t=lt("iframefcb");return Qe()[t]=()=>{gapi.load?s():r(m(e,"network-request-failed"))},ut(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>r(e)))}s()}})).catch((e=>{throw xt=null,e}))}(e),xt}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=library.eb8e75f8.js.map
